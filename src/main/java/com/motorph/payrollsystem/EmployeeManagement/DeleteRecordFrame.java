...
public class DeleteRecordFrame extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 390, -1, -1));
        ...
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 510, -1, -1));

        jLabel17.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel17.setText("Clothing Allowance:");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 540, -1, -1));

        jLabel18.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel18.setText("Semi-monthly Rate:");
        getContentPane().add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 570, -1, -1));

        jLabel19.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel19.setText("Hourly Rate:");
        getContentPane().add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 600, -1, -1));

        lastnametf.setEditable(false);
        lastnametf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(lastnametf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 90, 387, -1));

        firstnametf.setEditable(false);
        firstnametf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(firstnametf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 120, 387, -1));

        bdaytf.setEditable(false);
        bdaytf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(bdaytf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 150, 387, -1));

        addresstf.setEditable(false);
        addresstf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(addresstf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 180, 387, -1));

        phonenumtf.setEditable(false);
        phonenumtf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(phonenumtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 210, 387, -1));

        sssnumtf.setEditable(false);
        sssnumtf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(sssnumtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 240, 387, -1));

        philhealthtf.setEditable(false);
        philhealthtf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(philhealthtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 270, 387, -1));

        tinnumtf.setEditable(false);
        tinnumtf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(tinnumtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 300, 387, -1));

        pagibigtf.setEditable(false);
        pagibigtf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(pagibigtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 330, 387, -1));

        statustf.setEditable(false);
        statustf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(statustf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 360, 387, -1));

        positiontf.setEditable(false);
        positiontf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(positiontf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 390, 387, -1));

        supervisortf.setEditable(false);
        supervisortf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(supervisortf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 420, 387, -1));

        employeenumbertf.setEditable(false);
        employeenumbertf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(employeenumbertf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 60, 387, -1));

        basicsalarytf.setEditable(false);
        basicsalarytf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(basicsalarytf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 450, 387, -1));

        ricetf.setEditable(false);
        ricetf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(ricetf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 480, 387, -1));

        phonetf.setEditable(false);
        phonetf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(phonetf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 510, 387, -1));

        clothingtf.setEditable(false);
        clothingtf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(clothingtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 540, 387, -1));

        smratetf.setEditable(false);
        smratetf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(smratetf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 570, 387, -1));

        hourlyratetf.setEditable(false);
        hourlyratetf.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(hourlyratetf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 600, 387, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 640, 90, 30));
        ...
        jLabel20.setMaximumSize(new java.awt.Dimension(700, 700));
        jLabel20.setMinimumSize(new java.awt.Dimension(700, 700));
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 700, 700));
