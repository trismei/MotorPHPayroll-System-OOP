 ...
 */
package com.motorph.payrollsystem.PayrollCalculation;
...
public class PayslipFrame extends javax.swing.JDialog {
    ...
    public PayslipFrame(Employees employees) {
        ...
        philhealthTF.setText(employees.getPhNum());
    ...
    private void initComponents() {
        ...
        jTabbedPane1.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        ...
        jPanel1.add(lastNameTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 370, -1));

        firstNameTF.setEditable(false);
        firstNameTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(firstNameTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 130, 370, -1));

        birthdayTF.setEditable(false);
        birthdayTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(birthdayTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 160, 370, -1));

        adressTF.setEditable(false);
        adressTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(adressTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 190, 370, -1));

        phoneNumberTF.setEditable(false);
        phoneNumberTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(phoneNumberTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 220, 370, -1));

        sssTF.setEditable(false);
        sssTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(sssTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 250, 370, -1));

        philhealthTF.setEditable(false);
        philhealthTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(philhealthTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 280, 370, -1));

        tinNumTF.setEditable(false);
        tinNumTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(tinNumTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 310, 370, -1));

        pagibigTF.setEditable(false);
        pagibigTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(pagibigTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 340, 370, -1));

        statusTF.setEditable(false);
        statusTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(statusTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 370, 370, -1));
        ...
        jPanel1.add(positionTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 400, 370, -1));
        ...
        jPanel1.add(supervisorTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 430, 370, -1));
        ...
        jPanel1.add(employeeNumberTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 370, -1));
        ...
        jPanel1.add(basicSalaryTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 460, 370, -1));

        jLabel12.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel12.setText("Position:");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 400, -1, -1));

        riceTF.setEditable(false);
        riceTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(riceTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 490, 370, -1));

        jLabel13.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel13.setText("Immediate Supervisor:");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 430, -1, -1));

        phoneTF.setEditable(false);
        phoneTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(phoneTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 520, 370, -1));

        jLabel14.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel14.setText("Basic Salary:");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 460, -1, -1));

        clothingTF.setEditable(false);
        clothingTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(clothingTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 550, 370, -1));

        jLabel15.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel15.setText("Rice Subsidy:");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 500, -1, -1));

        semRateTF.setEditable(false);
        semRateTF.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(semRateTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 580, 370, -1));
        ...
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 550, -1, -1));
        ...
        jPanel1.add(hourlyRateTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 610, 370, -1));

        jLabel18.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel18.setText("Semi-monthly Rate:");
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 580, -1, -1));

        jLabel19.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel19.setText("Hourly Rate:");
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 610, -1, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 30, 20, 20));

        jLabel38.setBackground(new java.awt.Color(255, 255, 255));
        jLabel38.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel38.setForeground(new java.awt.Color(0, 0, 102));
        jPanel1.add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, 570, 600));

        jTabbedPane1.addTab("Employee Details", jPanel1);

        jPanel5.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel6.setBackground(new java.awt.Color(254, 242, 236));
        ...
        jPanel6.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 104, -1));
        jPanel6.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 240, -1, -1));

        jLabel40.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel40.setText("Salary Period:");
        jPanel6.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 104, -1));

        jLabel41.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel41.setText("Salary Earned:");
        jPanel6.add(jLabel41, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 104, -1));

        jLabel42.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel42.setText("Rice Allowance:");
        jPanel6.add(jLabel42, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 104, -1));

        jLabel43.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel43.setText("Phone Allowance:");
        jPanel6.add(jLabel43, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 110, -1));

        jLabel44.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel44.setText("Clothing Allowance:");
        jPanel6.add(jLabel44, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 120, -1));

        jLabel45.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel45.setText("Gross Salary:");
        jPanel6.add(jLabel45, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 104, -1));

        salperiodtf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        jPanel6.add(salperiodtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 33, 170, -1));

        salearnedtf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        jPanel6.add(salearnedtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 61, 170, -1));

        riceallowtf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        jPanel6.add(riceallowtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 89, 170, -1));

        phoneallowtf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        jPanel6.add(phoneallowtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 117, 170, -1));

        clothingallowtf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        jPanel6.add(clothingallowtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 145, 170, -1));

        grosstf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        ...
        jPanel6.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 104, -1));

        jLabel31.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel31.setText("SSS:");
        jPanel6.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 104, -1));

        jLabel33.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel33.setText("Philhealth:");
        jPanel6.add(jLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, 104, -1));

        jLabel34.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel34.setText("PAGIBIG:");
        jPanel6.add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, 104, -1));

        jLabel35.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel35.setText("Witholding Tax:");
        jPanel6.add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, 104, -1));

        jLabel36.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel36.setText("Total Deductions:");
        jPanel6.add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, 104, -1));

        jLabel37.setFont(new java.awt.Font("Thonburi", 1, 12)); // NOI18N
        jLabel37.setText("Net Salary:");
        jPanel6.add(jLabel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 460, 104, -1));

        nettf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        jPanel6.add(nettf, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 457, 170, -1));

        ssstf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        jPanel6.add(ssstf, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 274, 170, -1));

        phtf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        jPanel6.add(phtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 302, 170, -1));

        pgbtf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        jPanel6.add(pgbtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 333, 170, -1));

        taxtf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        jPanel6.add(taxtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(141, 361, 170, -1));

        tdeducttf.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        ...
        jPanel5.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 70, 340, 520));
        ...
        jLabel21.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel21.setText("Year:");
        jPanel2.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, -1, -1));

        jLabel22.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel22.setText("Month:");
        jPanel2.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, -1, -1));

        jLabel23.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel23.setText("Date:");
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, -1));
        ...
        jPanel2.add(y1cb, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, 110, -1));

        m1cb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "9", "10", "11", "12" }));
        jPanel2.add(m1cb, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 110, 110, -1));
        ...
        jPanel2.add(d1cb, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 110, -1));
        ...
        jLabel26.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel26.setText("Year:");
        jPanel2.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, -1, -1));

        jLabel27.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel27.setText("Month:");
        jPanel2.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, -1, -1));

        m2cb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "9", "10", "11", "12" }));
        jPanel2.add(m2cb, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 110, -1));

        y2cb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "2022" }));
        jPanel2.add(y2cb, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 210, 110, -1));

        jLabel29.setFont(new java.awt.Font("Thonburi", 0, 12)); // NOI18N
        jLabel29.setText("Date:");
        jPanel2.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, -1, -1));
        ...
        jPanel2.add(d2cb, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 270, 110, -1));

        jPanel5.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 240, 320));

        showpaybtn.setBackground(new java.awt.Color(249, 182, 17));
        showpaybtn.setFont(new java.awt.Font("Thonburi", 1, 12)); // NOI18N
        showpaybtn.setForeground(new java.awt.Color(255, 255, 255));
        showpaybtn.setText("Show Payslip");
        showpaybtn.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        showpaybtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                showpaybtnMouseClicked(evt);
            }
        });
        jPanel5.add(showpaybtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 410, 240, 30));
        ...
        jPanel5.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 30, 20, 20));

        jTabbedPane1.addTab("Generate Payslip", jPanel5);
    ...
    private void showpaybtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_showpaybtnMouseClicked
        ...
        employees.setsss(sssTF.getText());
        employees.setphilhealth(philhealthTF.getText());
        employees.settax(tinNumTF.getText());
        employees.setpagibig(pagibigTF.getText());
        ...
        String end = m2cb.getSelectedItem().toString()+"/"+
            ...
            try { 
                ...
                salearnedtf.setText(employees.computeSalaryEarned(hw));
                ...
                phtf.setText(employees.computePhilhealth());
                pgbtf.setText(employees.computePagibig());
                taxtf.setText(employees.computeTax());
                tdeducttf.setText(employees.computeTotalDeductions());
